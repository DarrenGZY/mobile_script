...
function TexturePackageList.LoadTexturePackageList(callbackfun)
	...
	LOG.std(nil, "info", "TexturePackageList", defaultPreviewImage);
	...
	LOG.std(nil, "info", "TexturePackageList", "LoadTexturePackageList after");
	local local_ds = {};
	local official_ds = {};
	TexturePackageList.ds.localDisk = local_ds;
	TexturePackageList.ds.official = official_ds;
	LOG.std(nil, "info", "TexturePackageList", info_path);
	if(not ParaIO.DoesFileExist(info_path, true)) then
		LOG.std(nil, "info", "TexturePackageList", "1");
		...
		LOG.std(nil, "info", "TexturePackageList", "2");
		hasInfoFile = true;
		TexturePackageList.GetLocalTexturePackDS(local_ds);
	...
	LOG.std(nil, "info", "TexturePackageList", "LoadTexturePackageList after 2");
end
...
function TexturePackageList.GetLocalTexturePackDS(ds)
	...
	LOG.std(nil, "info", "TexturePackageList", "GetLocalTexturePackDS in");
	...
	LOG.std(nil, "info", "TexturePackageList", "dir_default :%s", dir_default);
	LOG.std(nil, "info", "TexturePackageList", "GetLocalTexturePackDS find before");
	local result = commonlib.Files.Find({}, dir_default, 0, 1000, "*.*")
	LOG.std(nil, "info", "TexturePackageList", "GetLocalTexturePackDS find after");
	local _, file
	...
	LOG.std(nil, "info", "TexturePackageList", "GetLocalTexturePackDS out");
end
...
function TexturePackageList.LoadTexturePackagesInfoFromFile(filename,official_ds,local_ds)
	filename = filename or "worlds/BlockTextures/PackagesInfo.xml";
	LOG.std(nil, "info", "TexturePackageList", "loading 1");
	local rootXML = ParaXML.LuaXML_ParseFile(filename);
	LOG.std(nil, "info", "TexturePackageList", "loading 2");
	local packagenode;
